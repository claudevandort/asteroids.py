...
class SpaceShip(GameObject):
    ...
    def __init__(self, position):
        ...
        super(SpaceShip, self).__init__(position, load_sprite("spaceship"), Vector2(0))
...
class Asteroid(GameObject):
    ...
    def __init__(self, position, size=3):
        ...
        super(Asteroid, self).__init__(position, sprite, velocity)
...
class Bullet(GameObject):
    def __init__(self, position, velocity):
        super(Bullet, self).__init__(position, load_sprite("bullet"), velocity, False)
